...
// configuration step. It creates a namespace called `CppApi`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", CppApi::cmake::project_name, CppApi::cmake::project_version) };
